...
LOG_DIR="active_logs"
HEART_ARCHIVE="archives/heart_data_archive"
TEMP_ARCHIVE="archives/temperature_archive"
WATER_ARCHIVE="archives/water_archive"
...
archive_log() {
    ...
    base_name=$(echo "$log_file" | sed 's/_log\.log$//' | sed 's/\.log$//')
